...
rewards_algo3xavg,regrets_algo3xavg,expectations_algo3xavg = experiment(algo3xavg,bandits, satisfaction_level, nb_step, nb_repetition)
plt.plot(np.cumsum(regrets_algo3xavg), label="Algorithm 3 x Average reward")
rewards_ucb,regrets_ucb,expectations_ucb = experiment(ucb, bandits, satisfaction_level, nb_step, nb_repetition,confidence_multiplier=0.5)
plt.plot(np.cumsum(regrets_ucb), label="UCB1 (confidence * 0.5)")
rewards_ucb,regrets_ucb,expectations_ucb = experiment(ucb, bandits, satisfaction_level, nb_step, nb_repetition,confidence_multiplier=0.25)
plt.plot(np.cumsum(regrets_ucb), label="UCB1 (confidence * 0.25)")
rewards_ucb,regrets_ucb,expectations_ucb = experiment(ucb, bandits, satisfaction_level, nb_step, nb_repetition,confidence_multiplier=0.125)
